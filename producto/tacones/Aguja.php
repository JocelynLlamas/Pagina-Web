...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Tacones' AND P.subcategoria = 'Aguja'");
?>
...
<head>
    ...
    <title>Tacones Aguja</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Tacones Aguja</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>AGUJA</p></div>
