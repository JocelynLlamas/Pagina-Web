...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Tacones' AND P.subcategoria = 'Plataforma'");
?>
...
<head>
    ...
    <title>Tacones Plataforma</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Tacones Plataforma</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>TACONES DE PLATAFORMA</p></div>
