...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Botas' AND P.subcategoria = 'Muslo Alto'");
?>
...
<head>
    ...
    <title>Botas Muslo Alto</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Botas Muslo Alto</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>MUSLO ALTO</p></div>
