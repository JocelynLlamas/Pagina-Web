...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Botas' AND P.subcategoria = 'Rodilla Alta'");
?>
...
<head>
    ...
    <title>Botas Rodilla Alta</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Botas Rodilla Alta</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>RODILLA ALTA</p></div>
