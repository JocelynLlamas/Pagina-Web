...
session_start();
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria AND C.nombre = 'Botas'");
?>
...
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Todas las Botas</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>BOTAS</p></div>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col containerProducto border">
                ...
                <!--CARRITO-->
                <form method="post" action="funcionalidadesGenerales/insertaCarrito.php" class="texto">
                    Tallas disponibles
                    <div>
                ...
                <!--                FAVORITOS-->
                <form method="post" action="funcionalidadesGenerales/insertaFavoritos.php" class="texto">
                    Añade a favoritos
                    <?php
                    if (isset($_SESSION['email'])) {
                ...
                if (isset($_SESSION['email'])) {
                    ?>
                    <form method="post" action="funcionalidadesGenerales/insertaComentario.php" class="texto">
                        Añade un comentario
                        <div>
                    ...
                    if ($_SESSION['rol'] == 'Premium') {
                        ...
                        ?>
                        <!--                            ELIMINA PUBLICACION-->
                        <form method="post" action="funcionalidadesGenerales/eliminaPublicacion.php" class="texto">
                        ...
                        <!--                        PONE EN OFERTA-->
                        <form method="post" action="funcionalidadesGenerales/insertaOferta.php" class="texto">
                            <?php
                ...
                $archivos = $data->query("SELECT A.archivo, A.id_archivo, A.id_producto, P.id_producto AS idP
                                                FROM archivos A INNER JOIN productos P ON A.id_producto = P.id_producto
...
<!--                    <img class="img" src="data:image/jpg;base64, --><?php //echo base64_encode($archivo['archivo']);?><!--">-->
                            ...
                            <div class="justify-content-between">
                                ...
                                <div class="justify-content-center align-items-center rounded"
                                    ...
                                    if (isset($_SESSION['email']) && $_SESSION['rol'] == 'Premium') {
                                        ?>
                                        <form method="post" action="funcionalidadesGenerales/eliminaComentario.php"
                                              class="texto">
                                    ...
                                    <?php } else if (isset($_SESSION['email']) && $_SESSION['email'] == $comentarios['email'] && $_SESSION['rol'] == 'Basico') {
                                        ?>
                                        <form method="post" action="funcionalidadesGenerales/insertaComentario.php"
                                              class="texto">
                                            <div class="justify-content-center align-items-end btn-group"
                                                 style="text-align: end">
                                                <button class="btn btn-sm boton" type="submit"
