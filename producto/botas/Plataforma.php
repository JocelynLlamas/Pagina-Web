...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Botas' AND P.subcategoria = 'Plataforma'");
?>
...
<head>
    ...
    <title>Botas Plataforma</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Botas Plataforma</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>PLATAFORMA</p></div>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col containerProducto border">
                ...
                <a href="../../perfil/productoIndividual.php?id=<?php echo $producto['id_producto']; ?>"
                   style="color: white">
