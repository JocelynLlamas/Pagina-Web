...
$productos = $data->query("SELECT P.nombre_producto, P.id_producto, P.id_vendedor, U.id FROM productos P INNER JOIN usuarios U ON P.id_vendedor = U.id");
