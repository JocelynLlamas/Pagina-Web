...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  sale S ON P.id_producto = S.id_producto");
?>
...
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > SALE</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>SALE</p></div>
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="col containerProducto border">
                ...
                <a href="../../perfil/productoIndividual.php?id=<?php echo $imagen['id_producto'];?>" style="color: white">
