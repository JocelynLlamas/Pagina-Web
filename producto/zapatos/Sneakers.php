...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Zapatos' AND P.subcategoria = 'Sneakers'");
?>
...
<head>
    ...
    <title>Zapatos Sneakers</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Zapatos Sneakers</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>SNEAKERS</p></div>
