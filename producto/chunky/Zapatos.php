...
$productos = $data->query("SELECT * FROM productos P INNER JOIN  categoria C ON P.categoria = C.id_categoria 
                                AND C.nombre = 'Chunky' AND P.subcategoria = 'Zapatos'");
?>
...
<head>
    ...
    <title>Botas Chunky</title>
</head>
<body>
<a href="../../index.php"><p class="ubicacion">Inicio > Botas Chunky</p></a>
<div class="container">
    <div class="row">
        <div class="col">
            <div class="titulo"><p>CHUNKY</p></div>
